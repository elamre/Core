...
public class ServerLoop {
    ...
    public void start() {
        ...
        serverManager.addEntity(new Wall(0,2));
        serverManager.addEntity(new Tail(1,2));
        serverManager.addEntity(new Wall(2,2));
        serverManager.addEntity(new Wall(3,2));
        serverManager.addEntity(new Wall(4,2));
        serverManager.addEntity(new Wall(6,2));
        serverManager.addEntity(new Wall(7,2));
        serverManager.addEntity(new Wall(8,2));
        serverManager.addEntity(new Wall(9,2));
        serverManager.addEntity(new Wall(10,2));
        serverManager.addEntity(new Wall(11,2));
        serverManager.addEntity(new Wall(12,2));
